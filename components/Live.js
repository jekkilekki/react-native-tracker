    ...
    if (status === 'denied') {
      return (
        <View style={styles.center}>
          ...
          <Text>Location Services denied. You can fix this by visiting Settings and enabling Location Services for this app.</Text>
        </View>
      )
    }
        ...
        <View style={styles.metricContainer}>
          <View style={styles.metric}>
            ...
            <Text style={[styles.subHeader, { color: white }]}>
              {Math.round(coords.altitude * 3.2808)} ft (converted from m)
            </Text>
          </View>
          <View style={styles.metric}>
            <Text style={[styles.header, { color: white }]}>
            ...
            <Text style={[styles.subHeader, { color: white }]}>
              {(coords.speed * 2.2369).toFixed(1)} kph
            </Text>
          </View>
        </View>
      </View>
